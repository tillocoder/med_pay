...
import 'package:sample_bloc_mobile/src/domain/repositories/auth/register/register_repository_impl.dart';
...
import 'package:sample_bloc_mobile/src/domain/repositories/profile/profile_repository_impl.dart';
...
import 'presentation/bloc/auth/registr/registr_bloc.dart';
...
void authFeature() {
  sl
    ...
    ..registerFactory<ConfirmCodeBloc>(() => ConfirmCodeBloc(sl(), sl()))
